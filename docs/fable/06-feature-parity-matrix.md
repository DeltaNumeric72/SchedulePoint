...
| 019 | Manual scheduling & override | HIGH | Permanent capability; production **mechanism** is automated (I-05/C-08) | R19; SPEC-05 | 014 | M3 | in-progress *(2026-08-04, OPUS-M3-003: draft-only manual assignment/removal/reassignment with pins, provenance, required override reasons, capability-gated + audited, API-level; the grid/cell-editor UX pends M3-004)* |
