...
| M4 Automated scheduling | **IN PROGRESS — authorized 2026-08-07** against `7b579f2` (tag `milestone/M3`; entry record doc 34). M4-000 COMPLETE 2026-08-12 (000A `94af3c5` · 000B `a614f7e` · 000C `323d576`); **M4-001 ACCEPTED & MERGED 2026-08-12 (`b1aa64e`)** — closeout 2026-08-13. Next: OPUS-M4-001R (FAD-28 correction, doc 35 §6b), then M4-002..005. M3R remains PAUSED; stops before M5. *(Row corrected 2026-08-13 — it had never been updated for the M4 authorization.)* |
