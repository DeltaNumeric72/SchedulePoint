...
| M4 Automated scheduling | **IN PROGRESS — authorized 2026-08-07** against `7b579f2` (tag `milestone/M3`; entry record doc 34). M4-000 COMPLETE 2026-08-12 (000A `94af3c5` · 000B `a614f7e` · 000C `323d576`); M4-001 `b1aa64e` · M4-001R `efa1ffd` · M4-001S `d910af6` (migration 0017) · **M4-002 ACCEPTED & MERGED 2026-08-15 (`5e0ac4e`) — the E1 feasibility engine, 22/30 kinds evaluable both sides, snapshot v2, 15-class corpus.** Next: M4-003 (build lifecycle + scheduler UX) → M4-004 (E2) → M4-005 (integration/recovery/close). M3R remains PAUSED; stops before M5. *(Row corrected 2026-08-13 — it had never been updated for the M4 authorization.)* |
